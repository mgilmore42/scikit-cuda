...
if 'linux' in sys.platform:
    _libcusparse_libname_name = utils.resolve_lib('libcusparse.so')
    _libcusparse_libname_list = [_libcusparse_libname_name] if _libcusparse_libname_name is not None else []
